...
TennisResult TennisGame4::getResult() const
{
    ...
    TennisResult       result =
        Deuce(thisGame,
              GameServer(thisGame,
                         GameReceiver(thisGame,
                                      AdvantageServer(thisGame, AdvantageReceiver(thisGame, DefaultResult(thisGame))))))
            .getResult();
    return result;
}
...
bool TennisGame4::receiverHasAdvantage() const { return receiverScore >= 4 && (receiverScore - serverScore) == 1; }

bool TennisGame4::serverHasAdvantage() const { return serverScore >= 4 && (serverScore - receiverScore) == 1; }

bool TennisGame4::receiverHasWon() const { return receiverScore >= 4 && (receiverScore - serverScore) >= 2; }

bool TennisGame4::serverHasWon() const { return serverScore >= 4 && (serverScore - receiverScore) >= 2; }

bool TennisGame4::isDeuce() const { return serverScore >= 3 && receiverScore >= 3 && (serverScore == receiverScore); }
